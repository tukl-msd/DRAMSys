...
- Cycle-accurate **DDR5**, **LPDDR5/6** and **HBM3/4** modelling
- Extended analysis features for the **Trace Analyzer**
- **Academic** or **commercial** licenses available (please contact [DRAMSys@iese.fraunhofer.de](mailto:DRAMSys@iese.fraunhofer.de) for more information)
